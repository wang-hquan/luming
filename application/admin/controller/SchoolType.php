...
class SchoolType extends BaseController
{
    ...
    public function initialize()
    {
        ...
        $this->SchoolTypeModel =  new SchoolTypeModel()  ;
    }
    ...
    public function getData()
    {
        try{
            ...
            $data['lists'] =  $this->SchoolTypeModel->withSearch(['diySelect'],$condition)->select();
            $data['total'] =  $this->SchoolTypeModel->withSearch(['diyCount'],$condition)->count();
    ...
    public function getDataById()
    {
        ...
        $data =   $this->SchoolTypeModel->where('id',$post)->find();
        $this->ret['code'] = 200;
        $this->ret['data']= $data;
    ...
    public function  edit()
    {
        ...
        try {
            ...
            $rec = SchoolTypeModel::get(['id' => $param['id']]);
    ...
    public function add()
    {
        ...
        try {
            $param = $this->receiveParam($mustFields, $extFields);
            if ($this->SchoolTypeModel->save($param)) {
                $this->ret['code'] = 200;
                $this->ret['msg'] = '添加成功';
            } else {
                $this->ret['code'] = 500;
    ...
    public  function delete()
    {
        try {
            $post = $this->request->post('id');
            $this->SchoolTypeModel->destroy($post);
            $this->ret['code'] = 200;
            $this->ret['msg'] = 'success';
        } catch (\Exception $ex) {
            $this->ret['code'] = 500;
